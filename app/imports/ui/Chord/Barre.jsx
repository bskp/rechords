...
const Barre = ({ barre, frets, capo, finger, lite }) => {
  ...
  return (
    <g class='barre'>
      {capo &&
      <g class='capo'>
        <g transform={`translate(${getStringPosition(strings, strings)}, ${positions.fret[barreFrets[0].value]})`}>
          <path d={`
            M 0, 0
            m -4, 0
            a 4,4 0 1,1 8,0
        ...
        <rect
          ...
          height={8.25}
        />
        <g transform={`translate(${getStringPosition(1, strings)}, ${positions.fret[barreFrets[0].value]})`}>
          <path d={`
            M 0, 0
            m -4, 0
            a 4,4 0 1,1 8,0
